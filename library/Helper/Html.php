...
//        self::$encoding = 'utf-8';
        self::$encoding = \Yaf_Application::app()->getConfig()->application->encoding;
     ...
     */
    public static function appendJavascript(\Yaf_View_Interface $view, $args)
    {
     ...
     */
    public static function appendCss(\Yaf_View_Interface $view, $args)
    {
